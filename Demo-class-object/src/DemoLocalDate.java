...
// LocalDate, String, BigRDecimal -> immutable
//immutable -> the object has no metjod to revise itself
...
public class DemoLocalDate {
  public static void main(String[] args) {
    ...
    System.out.println("--------------find max date-------------");
 ...
 String s = "hello";
 s = s.concat ("word"); // one object reference, two object
