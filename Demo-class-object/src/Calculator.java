...
public class Calculator {
  ...
  System.out.println("instrance method, object instance reference, must be new object ");
  ...
  public double sum() { // method signature
    return BigDecimal.valueOf(this.x).add(BigDecimal.valueOf(this.y))
        .doubleValue(); 
  } // object instance reference, must be new object
