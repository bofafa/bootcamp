public class DemoStaticMethodVin {
    ...
    public static void main(String[] args) {
      ...
      System.out.println(encrypted); // ÈÊÌ <----line 88
  
      String original = decrypt(encrypted); //<---ÈÊÌ
      System.out.println(original); // abc <----- line 98
    ...
    // input String -> output String <------line 33
    ...
    public static String encrypt2(String password) { //<-------- line 36
      char[] characters = password.toCharArray();
      String encrypted = "";
      int left = -1, right = -1;
      for (int i = 0; i < characters.length; i++) {
    ...
    public static String decrypt(String encrypted) { //<------ string  就OK
